<x-layout>
    ...
    <div class="h-220 bg-gray-100 flex flex-col gap-4 items-center justify-center p-6">
        <div class="w-full max-w-xl bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            <div class="divide-y">
                <div class="flex justify-between px-6 py-4">
                    <span class="text-gray-500">Codigo Estudiante</span>
        ...
        <div class="flex gap-2">
            <a href="/students" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded mt-4 inline-block">
                Volver a estudiantes
            </a>
            <a href="/students/{{$data['code']}}/edit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded mt-4 inline-block">
                Editar Estudiante
            </a>
        </div>
    </div>
